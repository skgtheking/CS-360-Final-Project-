...
CREATE TABLE IF NOT EXISTS `preference` (
  ...
  `vandalID` int(11) DEFAULT NULL,
  `apartmentType` varchar(50) DEFAULT NULL,
  `location` varchar(255) DEFAULT NULL,
  `distance` varchar(50) DEFAULT NULL,
  `approximateRate` int(11) DEFAULT NULL,
  `messStatus` varchar(50) DEFAULT NULL,
  `noVandals` int(11) DEFAULT NULL,
  `other` text,
  `status` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `preference` (`preferenceID`, `vandalID`, `apartmentType`, `location`, `distance`, `approximateRate`, `messStatus`, `noVandals`, `other`, `status`) VALUES
(1, 7, 'Residence', 'fdfs', '1', 34, 'With  Mess', 3432, 'gdfgdfgfd', 0),
(2, 7, 'Residence', 'fdsfds', '1 Mile', 54, 'With  Mess', 45, '4543543534', 0);
